...
class fr_buscar : Fragment() {
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.activity_recycler_buscar, container, false)
        var alldataborrar = view?.findViewById<RecyclerView>(R.id.recyclerview_buscar)
        ...
        val adapter = Adaptador_recycler_buscar()
